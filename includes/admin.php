...
$j(document).ready(function() {
 ...
 $j("#trainer-img").attr('src' ,'<?php echo plugins_url('/pkmn-trainer');?>/images/' +singleValues + '.png');
 ...
 $j("#pkmn-img1").attr('src' ,'<?php echo plugins_url('/pkmn-trainer');?>/images/' +singleValues + '.png');
 ...
 $j("#pkmn-img2").attr('src' ,'<?php echo plugins_url('/pkmn-trainer');?>/images/' +singleValues + '.png');
 ...
 $j("#pkmn-img3").attr('src' ,'<?php echo plugins_url('/pkmn-trainer');?>/images/' +singleValues + '.png');
 ...
 $j("#pkmn-img4").attr('src' ,'<?php echo plugins_url('/pkmn-trainer');?>/images/' +singleValues + '.png');
 ...
 $j("#pkmn-img5").attr('src' ,'<?php echo plugins_url('/pkmn-trainer');?>/images/' +singleValues + '.png');
 ...
 $j("#pkmn-img6").attr('src' ,'<?php echo plugins_url('/pkmn-trainer');?>/images/' +singleValues + '.png');
...
<?php } ?>
<img src='<?php echo plugins_url('/pkmn-trainer/images/'.$trainer.'.png');?>' alt='<?php echo $trainer;?>' /> <img src='<?php echo plugins_url('/pkmn-trainer/images/'.$pokemon_1.'.png');?>' alt='<?php echo $pokemon_1;?>' /> <img src='<?php echo plugins_url('/pkmn-trainer/images/'.$pokemon_2.'.png');?>' alt='<?php echo $pokemon_2;?>' /> <img src='<?php echo plugins_url('/pkmn-trainer/images/'.$pokemon_3.'.png');?>' alt='<?php echo $pokemon_3;?>' /> <img src='<?php echo plugins_url('/pkmn-trainer/images/'.$pokemon_4.'.png');?>' alt='<?php echo $pokemon_4;?>' /> <img src='<?php echo plugins_url('/pkmn-trainer/images/'.$pokemon_5.'.png');?>' alt='<?php echo $pokemon_5;?>' /> <img src='<?php echo plugins_url('/pkmn-trainer/images/'.$pokemon_6.'.png');?>' alt='<?php echo $pokemon_6;?>' />
...
?>
        ...
        <td><img src='<?php echo plugins_url('/pkmn-trainer');?>/images/0.png' id='trainer-img'/></td>
      </tr>
      <tr valign="top">
...
?>
        ...
        <td><img src='<?php echo plugins_url('/pkmn-trainer');?>/images/0.png' id='pkmn-img1'/></td>
      </tr>
      <tr valign="top">
...
?>
        ...
        <td><img src='<?php echo plugins_url('/pkmn-trainer');?>/images/0.png' id='pkmn-img2'/></td>
      </tr>
      <tr valign="top">
...
?>
        ...
        <td><img src='<?php echo plugins_url('/pkmn-trainer');?>/images/0.png' id='pkmn-img3'/></td>
      </tr>
      <tr valign="top">
...
?>
        ...
        <td><img src='<?php echo plugins_url('/pkmn-trainer');?>/images/0.png' id='pkmn-img4'/></td>
      </tr>
      <tr valign="top">
...
?>
        ...
        <td><img src='<?php echo plugins_url('/pkmn-trainer');?>/images/0.png' id='pkmn-img5'/></td>
      </tr>
      <tr valign="top">
...
?>
        ...
        <td><img src='<?php echo plugins_url('/pkmn-trainer');?>/images/0.png' id='pkmn-img6'/></td>
      </tr>
    </tbody>
  </table>
  <p class="submit">
