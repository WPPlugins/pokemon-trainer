...
?>
 ...
 <img src='<?php echo plugins_url('/pkmn-trainer/images/'.$trainer.'.png');?>' alt='<?php echo $trainer;?>' />
 <img src='<?php echo plugins_url('/pkmn-trainer/images/'.$pokemon_1.'.png');?>' alt='<?php echo $pokemon_1;?>' />
  <img src='<?php echo plugins_url('/pkmn-trainer/images/'.$pokemon_2.'.png');?>' alt='<?php echo $pokemon_2;?>' />
   <img src='<?php echo plugins_url('/pkmn-trainer/images/'.$pokemon_3.'.png');?>' alt='<?php echo $pokemon_3;?>' />
    <img src='<?php echo plugins_url('/pkmn-trainer/images/'.$pokemon_4.'.png');?>' alt='<?php echo $pokemon_4;?>' />
     <img src='<?php echo plugins_url('/pkmn-trainer/images/'.$pokemon_5.'.png');?>' alt='<?php echo $pokemon_5;?>' />
      <img src='<?php echo plugins_url('/pkmn-trainer/images/'.$pokemon_6.'.png');?>' alt='<?php echo $pokemon_6;?>' />
